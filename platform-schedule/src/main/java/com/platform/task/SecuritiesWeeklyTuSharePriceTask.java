...
@Component
public class SecuritiesWeeklyTuSharePriceTask extends AbstractSecuritiesCodesIteratorWeeklyTask{
	...
	public ResultSupport<String> process(String securitiesCode, SimpleTaskParam taskParam, Map<String, String> argMap, Date date) {
		...
		conditions.put("asset", "E");
		conditions.put("adj", DateUtil.getDate(date, DateUtil.DAY_FORMATTER_2));
		conditions.put("adj", "qfq");
		conditions.put("freq", "W");
